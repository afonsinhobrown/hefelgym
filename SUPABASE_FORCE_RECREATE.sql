-- FORÇAR RECRIAÇÃO COMPLETA DE TODAS AS TABELAS
...
DROP TABLE IF EXISTS access_devices CASCADE;
DROP TABLE IF EXISTS instructors CASCADE;
DROP TABLE IF EXISTS classes CASCADE;
DROP TABLE IF EXISTS attendance CASCADE;
DROP TABLE IF EXISTS product_expenses CASCADE;
DROP TABLE IF EXISTS gym_expenses CASCADE;
