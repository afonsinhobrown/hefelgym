...
try {
    ...
    // Regex matches independent of specific indentation or hidden chars
    // Matches from // WEBHOOK... down to the end of the app.post block roughly
    // Or we just find the specific unique string "api/webhook/hikvision" and find the matching }

    // Simplest robust strategy: Use a known unique start string and a known unique end string
    // Start: // WEBHOOK HIKVISION (Real-time Events - RAW HANDLER)
    // End: const hikvision = {
