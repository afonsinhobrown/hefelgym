    ...
    return (
        <div className="settings-page animate-fade-in p-6 h-full overflow-y-auto">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                {/* TROCAR SENHA */}
                <div className="card bg-gray-800 p-6 rounded-lg border border-gray-700 h-fit">
                    <h3 className="text-xl font-bold mb-4 flex items-center gap-2"><Lock size={20} /> Segurança da Conta</h3>
                    <p className="text-sm text-gray-400 mb-6">Mude a sua palavra-passe de acesso ao sistema.</p>

                    <form onSubmit={handlePasswordChange} className="space-y-4">
                        <div>
                            <label className="block text-xs text-gray-400 mb-1">Palavra-passe Atual</label>
                            <input
                                type="password"
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            ...
                            <div>
                                <label className="block text-xs text-gray-400 mb-1">Confirmar Nova</label>
                                <input
                                    type="password"
                                    className="w-full bg-gray-700 border-none rounded p-2 text-white"
                        ...
                        {pwdStatus.msg && (
                            <div className={`p-3 rounded text-sm ${pwdStatus.type === 'success' ? 'bg-green-500/20 text-green-400' : 'bg-red-500/20 text-red-400'}`}>
                                {pwdStatus.msg}
                            </div>
                        )}

                        <button className="w-full bg-slate-700 hover:bg-slate-600 text-white font-bold py-3 rounded transition-colors">
